...
* [Full project report (PDF)](Retail_Customer_Retention_Analytics_Report.pdf) - goes into more detail on the datasets, DAX formulas, and methodology
* [Dashboard screenshots (PDF)](Dashboard_pdf.pdf)
